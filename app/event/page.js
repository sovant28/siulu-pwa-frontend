  ...
  return (
    <div className="flex flex-col w-full min-h-[100dvh] bg-[#F6F7F9] font-sans pb-[calc(env(safe-area-inset-bottom)+76px)] relative overflow-x-hidden">
      ...
      <div className="px-6 mt-5">
        <div className="relative w-full flex items-center bg-slate-100 rounded-full px-4.5 py-3">
          ...
          <input
            ...
            className="w-full text-xs font-semibold text-slate-800 bg-transparent border-none outline-none placeholder-slate-400"
          />
        </div>
      </div>
      ...
      <div className="px-6 mt-6">
        <h2 className="text-[13px] font-black text-slate-800 tracking-wider">
      ...
      <div className="px-6 mt-2.5 space-y-1">
        {loading ? (
            ...
            return (
              ...
              >
                ...
                <div className="ml-4 flex-1 min-w-0 flex flex-col justify-center">
                  <h3 className="text-[13px] font-bold text-slate-800 truncate leading-snug">
                    {event.nama_tempat}
                  </h3>
                  
                  {event.lokasi_wilayah && (
                    <div className="mt-1 flex items-center text-[10px] font-semibold text-slate-700 gap-1 truncate">
                  ...
                  {dateInfo && dateInfo.startStr && (
                    <div className="mt-2 text-[10px] font-bold text-slate-700 flex items-center gap-1.5 truncate">
          ...
          <div className="text-center py-12 px-6 bg-white rounded-2xl border border-slate-200 mt-4">
            ...
            <p className="text-xs text-slate-600 font-bold">Tidak ada event yang cocok.</p>
          </div>
        )}
      </div>
