        ...
        <div className="grid grid-cols-4 gap-y-4 gap-x-3 mt-4">
          ...
          <div className="flex flex-col items-center space-y-1.5">
            <button
              ...
              className="w-14 h-14 flex items-center justify-center rounded-2xl bg-white border border-slate-100 shadow-[0_4px_10px_rgba(0,0,0,0.03)] active:scale-90 transition-all duration-150 cursor-pointer select-none outline-none overflow-hidden"
              style={{ WebkitTapHighlightColor: 'transparent' }}
            >
            ...
            >
              <svg viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="#000000" className="w-7 h-7">
                ...
                <g id="SVGRepo_iconCarrier">
                  ...
                  <path d="M67.2 494l1 31c2.2 67.7 26.2 133.6 69.6 190.4 41.6 54.5 99.2 99.2 167.9 129.3 15.2 6.7 32.9-0.2 39.5-15.4 6.7-15.2-0.2-32.9-15.4-39.5-59-26-108.9-64.3-144.4-110.8-29-38-47.5-80.7-54.4-125h762.6c-7 44.8-25.8 87.9-55.4 126.3-36.1 46.8-86.8 85.2-146.8 110.9-15.2 6.5-22.2 24.2-15.7 39.4 4.9 11.4 15.9 18.2 27.6 18.2 4 0 8-0.8 11.8-2.4 144.5-62.2 237-185.3 241.3-321.4l1-31H67.2z" fill="currentColor"></path>
                  <path d="M591.9 800.1h-159c-35.2 0-64.1 28.8-64.1 64.1s28.8 64.1 64.1 64.1h159c35.2 0 64.1-28.8 64.1-64.1s-28.9-64.1-64.1-64.1z m0 68.1h-159c-2.1 0-4.1-2-4.1-4.1s2-4.1 4.1-4.1h159c2.1 0 4.1 2 4.1 4.1s-2 4.1-4.1 4.1z" fill="currentColor"></path>
                  <path d="M498.1 373.5c-9.6-13.5-28.4-16.6-41.9-6.9-13.5 9.6-16.6 28.4-6.9 41.9 10.8 15.1 16.6 33 16.6 51.7 0 16.6 13.4 30 30 30s30-13.4 30-30c0-31.4-9.6-61.4-27.8-86.7zM432.4 321.8c-17.7-7.1-36.3-10.7-55.5-10.7-82.2 0-149 66.8-149 149 0 16.6 13.4 30 30 30s30-13.4 30-30c0-49.1 39.9-89 89-89 11.5 0 22.6 2.1 33.1 6.4 15.4 6.2 32.8-1.3 39-16.7 6.2-15.4-1.2-32.9-16.6-39z" fill="currentColor"></path>
                  <path d="M549.4 274.7c-46.7-45.6-107.7-70.8-171.8-70.8-64.1 0-125.1 25.1-171.8 70.8-46.1 45.1-74 106-78.6 171.4-1.2 16.5 11.3 30.9 27.8 32 16.5 1.1 30.9-11.3 32-27.8 3.5-50.8 25.1-97.9 60.7-132.7 35.4-34.6 81.5-53.7 129.9-53.7 48.3 0 94.5 19.1 129.9 53.7 48.3 0 94.5 19.1 129.9 53.7 35.6 34.8 57.1 81.9 60.7 132.7 1.1 15.8 14.3 27.9 29.9 27.9 0.7 0 1.4 0 2.1-0.1 16.5-1.2 29-15.5 27.8-32-4.6-65.4-32.5-126.3-78.6-171.4zM895.1 385.9c-11.5-19.4-27.7-36.6-48.1-51.2l53.9-58.3c11.2-12.2 10.5-31.2-1.7-42.4s-31.2-10.5-42.4 1.7l-65 70.4c-5-1.8-10.1-3.5-15.3-5l82.4-159.2c7.6-14.7 1.9-32.8-12.9-40.4-14.7-7.6-32.8-1.9-40.4 12.9l-91.2 176.3c-5.5-0.3-11.1-0.5-16.7-0.5-21.9 0-43.5 2.4-64.3 7.2-16.1 3.7-26.2 19.8-22.5 36 3.7 16.1 19.8 26.2 36 22.5 16.3-3.8 33.4-5.7 50.7-5.7 43.6 0 84.2 11.8 114.3 33.3 27.1 19.3 42 44 42 69.5 0 16.6 13.4 30 30 30s30-13.4 30-30c0-23.5-6.3-46.1-18.8-67.1z" fill="currentColor"></path>
                </g>
              </svg>
            </button>
            ...
            >
              <svg viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="#000000" className="w-7 h-7">
                ...
                <g id="SVGRepo_iconCarrier">
                  ...
                  <path d="M864.4 237.6H161.6c-51.6 0-93.6 42-93.6 93.6v40.3c0 16.6 13.4 30 30 30s30-13.4 30-30v-40.3c0-18.5 15.1-33.6 33.6-33.6h702.9c18.5 0 33.6 15.1 33.6 33.6v43.3c0 16.6 13.4 30 30 30s30-13.4 30-30v-43.3c-0.1-51.7-42.1-93.6-93.7-93.6zM738.1 466.5c0 16.6 13.4 30 30 30H898v303.2c0 18.5-15.1 33.6-33.6 33.6H161.6c-18.5 0-33.6-15.1-33.6-33.6V496.5h128c16.6 0 30-13.4 30-30s-13.4-30-30-30H68v363.2c0 51.6 42 93.6 93.6 93.6h702.9c51.6 0 93.6-42 93.6-93.6V436.5h-190c-16.5 0-30 13.4-30 30z" fill="currentColor"></path>
                  <path d="M604.1 188c4.6 0 8.7 4 8.7 8.7v6.1c0 4.6-4 8.7-8.7 8.7H420.2c-4.6 0-8.7-4-8.7-8.7v-6.1c0-4.6 4-8.7 8.7-8.7h183.9m0-60H420.2c-37.8 0-68.7 30.9-68.7 68.7v6.1c0 37.8 30.9 68.7 68.7 68.7H604c37.8 0 68.7-30.9 68.7-68.7v-6.1c0-37.8-30.9-68.7-68.6-68.7z" fill="currentColor"></path>
                  <path d="M512.1 645.2c-33.5 0-74.3-21-95.6-33.6-13.8-8.1-26.9-17-36.9-25.1-12.9-10.4-24.7-22.2-24.7-38.5V441.2h311.9V548c0 16-11.5 27.8-24 38.2-12.7 10.6-31.7 8.9-42.2-3.9-10.6-12.7-8.9-31.7 3.9-42.2 0.9-0.7 1.7-1.4 2.4-2v-36.9H414.8v36.6c7 6 21.2 16.2 39.8 26.5 28 15.4 48.1 20.9 57.5 20.9 2.9 0 8-0.5 16.2-3 15.9-4.7 32.6 4.3 37.3 20.2 4.7 15.9-4.3 32.6-20.2 37.3-12.1 3.6-23.3 5.5-33.3 5.5z" fill="currentColor"></path>
                </g>
              </svg>
            </button>
