...
export default function AppHome() {
  ...
  return (
    <div className="flex flex-col w-full min-h-[100dvh] bg-white font-sans pb-[calc(env(safe-area-inset-bottom)+68px)] relative overflow-x-hidden z-0">
      ...
      <header className="w-full flex flex-col px-5 pt-[calc(env(safe-area-inset-top)+16px)] pb-3 relative z-10 space-y-4">
        {/* Row 1: Profile & Greeting & Weather */}
        <div className="flex items-center justify-between w-full">
          <div className="flex items-center space-x-3">
            {/* Avatar (Clickable to profile/login) */}
            <div 
              onClick={() => router.push(user ? '/profile' : '/login')}
              className="relative w-10 h-10 rounded-full overflow-hidden border border-slate-100 bg-slate-50 flex-shrink-0 cursor-pointer active:scale-95 transition-all"
            ...
            <div className="flex flex-col text-left">
              <span className="text-[10px] font-bold text-slate-400 tracking-wider leading-none">
                {greeting}
              </span>
              {user ? (
                <span 
                  onClick={() => router.push('/profile')}
                  className="text-sm font-black text-slate-800 mt-1 cursor-pointer hover:underline leading-none"
                >
                  {username}
                </span>
              ) : (
                ...
                >
                  <span className="text-sm font-black text-slate-800 leading-none">Tamu</span>
                  <span className="h-1 w-1 rounded-full bg-slate-300"></span>
                  <span className="text-[10px] font-extrabold text-[#4C1D95] hover:underline leading-none">Masuk</span>
                </div>
              )}
            </div>
          </div>

          {/* Logo "siulu" on the right or weather */}
          <div className="flex items-center space-x-2">
            <span className="text-lg font-black text-[#BE1641] tracking-tight select-none mr-2">siulu</span>
            <div className="flex items-center space-x-1.5 bg-slate-50 border border-slate-100 rounded-full px-3 py-1.5 text-[10px] font-bold text-slate-600 select-none">
      ...
      <div className="px-5 mt-1.5">
        <div
          ...
          className="w-full flex items-center bg-slate-50 border border-slate-100 rounded-2xl px-4 py-3 active:scale-[0.99] transition cursor-pointer select-none"
          style={{ WebkitTapHighlightColor: 'transparent' }}
        >
        ...
        <div className="grid grid-cols-4 gap-y-5 gap-x-4 mt-5">
          ...
          <div className="flex flex-col items-center space-y-2">
            <button
              ...
              className="w-14 h-14 flex items-center justify-center rounded-[18px] bg-rose-50 active:scale-95 transition duration-150 cursor-pointer select-none outline-none overflow-hidden"
              style={{ WebkitTapHighlightColor: 'transparent' }}
            >
              <Calendar className="w-5.5 h-5.5 text-rose-600" />
            </button>
            <span className="text-[11px] font-bold text-slate-700 tracking-wide select-none">Event</span>
          </div>
          ...
          <div className="flex flex-col items-center space-y-2">
            <button
              onClick={() => router.push('/destinasi')}
              className="w-14 h-14 flex items-center justify-center rounded-[18px] bg-blue-50 active:scale-95 transition duration-150 cursor-pointer select-none outline-none overflow-hidden"
              style={{ WebkitTapHighlightColor: 'transparent' }}
            >
              <Compass className="w-5.5 h-5.5 text-blue-600" />
            </button>
            <span className="text-[11px] font-bold text-slate-700 tracking-wide select-none">Wisata</span>
          </div>
          ...
          <div className="flex flex-col items-center space-y-2">
            <button
              ...
              className="w-14 h-14 flex items-center justify-center rounded-[18px] bg-emerald-50 active:scale-95 transition duration-150 cursor-pointer select-none outline-none overflow-hidden"
              style={{ WebkitTapHighlightColor: 'transparent' }}
            >
              <Utensils className="w-5.5 h-5.5 text-emerald-600" />
            </button>
            <span className="text-[11px] font-bold text-slate-700 tracking-wide select-none">Kuliner</span>
          </div>
          ...
          <div className="flex flex-col items-center space-y-2">
            <button
              ...
              className="w-14 h-14 flex items-center justify-center rounded-[18px] bg-amber-50 active:scale-95 transition duration-150 cursor-pointer select-none outline-none overflow-hidden"
              style={{ WebkitTapHighlightColor: 'transparent' }}
            >
              <Hotel className="w-5.5 h-5.5 text-amber-600" />
            </button>
            <span className="text-[11px] font-bold text-slate-700 tracking-wide select-none">Hotel</span>
          </div>

          {/* Card 5: Tiket */}
          <div className="flex flex-col items-center space-y-2">
            <div className="relative w-14 h-14 opacity-60 saturate-75">
              <span className="absolute -top-1 -right-1 bg-[#4C1D95] text-white text-[6px] font-black px-1.5 py-0.5 rounded-full border border-white z-10 leading-none tracking-wide select-none pointer-events-none scale-90">Soon</span>
              <button
                disabled
                className="w-full h-full flex items-center justify-center rounded-[18px] bg-slate-50 cursor-default select-none outline-none overflow-hidden"
              >
                <Ticket className="w-5.5 h-5.5 text-slate-400" />
              </button>
            </div>
            <span className="text-[11px] font-bold text-slate-400 tracking-wide select-none">Tiket</span>
          </div>
          ...
          <div className="flex flex-col items-center space-y-2">
            <div className="relative w-14 h-14 opacity-60 saturate-75">
              ...
              <button
                disabled
                className="w-full h-full flex items-center justify-center rounded-[18px] bg-violet-50 cursor-default select-none outline-none overflow-hidden"
              >
                <Gift className="w-5.5 h-5.5 text-violet-400" />
              </button>
            </div>
            <span className="text-[11px] font-bold text-slate-400 tracking-wide select-none">Oleh-oleh</span>
          </div>
          ...
          <div className="flex flex-col items-center space-y-2">
            <div className="relative w-14 h-14 opacity-60 saturate-75">
              ...
              <button
                disabled
                className="w-full h-full flex items-center justify-center rounded-[18px] bg-orange-50 cursor-default select-none outline-none overflow-hidden"
              >
                <Megaphone className="w-5.5 h-5.5 text-orange-400" />
              </button>
            </div>
            <span className="text-[11px] font-bold text-slate-400 tracking-wide select-none">Aduan</span>
          </div>
          ...
          <div className="flex flex-col items-center space-y-2">
            <div className="relative w-14 h-14 opacity-60 saturate-75">
              ...
              <button
                disabled
                className="w-full h-full flex items-center justify-center rounded-[18px] bg-sky-50 cursor-default select-none outline-none overflow-hidden"
              >
                <HelpCircle className="w-5.5 h-5.5 text-sky-400" />
              </button>
            </div>
            <span className="text-[11px] font-bold text-slate-400 tracking-wide select-none">Bantuan</span>
          </div>
        </div>
      </section>
