        ...
        <div className="grid grid-cols-4 gap-y-4 gap-x-3 mt-4">
          ...
          <div className="flex flex-col items-center space-y-1.5">
            <button
              ...
              className="w-14 h-14 flex items-center justify-center rounded-2xl bg-white border border-slate-100 shadow-[0_4px_10px_rgba(0,0,0,0.03)] hover:shadow-[0_6px_14px_rgba(0,0,0,0.05)] hover:border-slate-200/50 active:scale-90 transition-all duration-150 cursor-pointer select-none outline-none"
              style={{ WebkitTapHighlightColor: 'transparent' }}
            >
