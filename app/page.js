        ...
        <div className="grid grid-cols-4 gap-y-4 gap-x-3 mt-4">
          ...
          <div className="flex flex-col items-center space-y-1.5">
            <button
              ...
              className="w-14 h-14 flex items-center justify-center active:scale-90 transition-all duration-150 cursor-pointer select-none outline-none overflow-hidden"
              style={{ WebkitTapHighlightColor: 'transparent' }}
            >
