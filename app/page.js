  ...
  return (
    <div className="flex flex-col w-full min-h-[100dvh] bg-[#F6F7F9] font-sans pb-[calc(env(safe-area-inset-bottom)+68px)] relative overflow-x-hidden">
        ...
        <div className="flex justify-between items-center w-full">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="flex flex-col text-left">
              <span className="text-[12px] font-semibold text-slate-600 leading-tight">{greeting}</span>
              <span className="text-[14px] font-black text-slate-800 leading-normal tracking-wide">
                {username || "Guest"}
              </span>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-1.5 text-slate-500">
            <span className="text-[11px] font-bold tracking-wide">Tana Toraja, Indonesia</span>
      ...
      <section className="px-6 mt-6">
        <h3 className="text-base font-semibold text-slate-800">Popular Categories</h3>
        <div className="grid grid-cols-4 gap-3 mt-4">
          ...
          >
            ...
            <span className="text-[11px] font-normal text-black tracking-wide">Event</span>
          </div>
          ...
          >
            ...
            <span className="text-[11px] font-normal text-black tracking-wide">Destinasi</span>
          </div>
          ...
          >
            ...
            <span className="text-[11px] font-normal text-black tracking-wide">Kuliner</span>
          </div>
          ...
          >
            ...
            <span className="text-[11px] font-normal text-black tracking-wide">Hotel</span>
          </div>
          ...
          >
            ...
            <span className="text-[11px] font-normal text-black tracking-wide">Tiket</span>
          </div>
          ...
          >
            ...
            <span className="text-[11px] font-normal text-black tracking-wide">Oleh-oleh</span>
          </div>
          ...
          >
            ...
            <span className="text-[11px] font-normal text-black tracking-wide">Pengaduan</span>
          </div>
          ...
          >
            ...
            <span className="text-[11px] font-normal text-black tracking-wide">Darurat</span>
          </div>
        </div>
      </section>
