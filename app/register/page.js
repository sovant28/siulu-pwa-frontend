    ...
    <div className="flex flex-col w-full min-h-[100dvh] bg-[#F6F7F9] font-sans pb-10 relative overflow-x-hidden">
      ...
      <div className="px-6 mt-6 max-w-md mx-auto w-full flex-grow flex flex-col justify-start">
        ...
        <div className="bg-white border border-slate-200/80 rounded-3xl p-6 space-y-6">
            ...
            <>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-center space-x-1.5 text-[10px] font-bold text-slate-400 select-none">
                  ...
                  <span>Daftar aman didukung oleh Google & Supabase</span>
                </div>
              </div>
              ...
              <form onSubmit={handleRegister} className="space-y-4">
                ...
                <div className="space-y-1.5">
                  <label className="block text-sm font-bold text-slate-700 pl-1">Nama Lengkap</label>
                  <div className="relative">
                    <User className="w-4.5 h-4.5 text-slate-400 absolute left-4.5 top-4" />
                    <input
                      type="text"
                      required
          ...
          {/* Eye-catching Login CTA Button */}
          {!success && (
            <div className="pt-4 border-t border-slate-100 space-y-3">
              <p className="text-xs font-semibold text-slate-400 text-center">Sudah memiliki akun?</p>
              <button
                onClick={() => router.push('/login')}
